...
import 'package:hostel_mess_2/features/home_page/pages/food_attendance_page/presentation/widgets/success_card.dart';
...
class _AttendanceDialogState extends State<AttendanceDialog>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<FoodAttendanceBloc, FoodAttendanceState>(
                ...
                if (state.successfullyAttendedStudent != null)
                  Positioned.fill(
                    child: Container(
                      ...
                      child: Center(
                        child: SuccessCard(
                          student: state.successfullyAttendedStudent!,
                          room: state.successfullyAttendedStudentRoom,
                        ),
                      ),
                    ),
                  ),
